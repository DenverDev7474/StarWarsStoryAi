...
import { setHeroStarship, setVillainStarship } from '../generator/generatorSlice';
...
function StarshipModal({ starship, onClose, selected, show }: StarshipModalProps) {
  ...
  return (
    <Modal show={show}>
      ...
      <Modal.Body>
        <Button variant="primary" onClick={addAsHeroStarship} disabled={!!heroStarship}>
          Add as Hero Starship
        </Button>
        <Button variant="danger" onClick={addAsVillainStarship} disabled={!!villainStarship}>
